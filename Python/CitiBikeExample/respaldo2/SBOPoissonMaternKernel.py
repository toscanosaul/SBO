...
##lambdaParameter are the parameters of the Poisson processes for W. It can be empty if poisson=False
   ...
   #     a,b,gamma,BN,L,B=self.update(self._points,n,self._y,self._X,self._W,xNew,wNew)
    ...
    def optimize(self,n):
        self.getNPoints(n)
        x,val=SteepestAscent_aN (self._n,self._n1,self._n2,self._X,self._W,aN_grad,self._c,self._d,self._y,self._muStart,self._variance0,self._alpha1,self._alpha2,self._lambda,self._k)
        return x,val
