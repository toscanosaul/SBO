...
class GaussianProcess:
    def __init__(self,dimKernel,numberTraining,numberInf=1,trainingData=None,
        ...
        Arguments:
            ...
            -numberTraining: Numer of training data as a list (for each information source).
        ...
        self.numberInf=numberInf
        if trainingData is not None:
            self.data=trainingData.copyData()
    
class SBOGP(GaussianProcess):
    def __init__(self,B,dimNoiseW,dimPoints,combineInfSources,gradXBforAn=None, computeLogProductExpectationsForAn=None,
                 SEK=True,*args,**kargs):
        ...
        Arguments:
            ...
            -combineInfSources:Function to combine the GP's means of the inf sources
                               on the GP of the objective.
        """
        self.SBOGP_name="SBO"
        self.n1=dimPoints
        self.n2=dimNoiseW
        ...
        self.combineInfSources=combineInfSources
        if SEK:
            self._k=[]
    ...
    def aN_grad(self,x,L,n,dataObj,infSource,gradient=True,onlyGradient=False,logproductExpectations=None):
        """
    ...
    def anGrad(self,x,L,n,dataObj,gradient=True,onlyGradient=False,logproductExpectations=None):
        ...
        if len(temp)==1:
            return self.combineInfSources(a[0],a[1])
        else:
            return self.combineInfSources(a[0][0],a[1][0]),self.combineInfSources(a[0][1],a[1][1])
