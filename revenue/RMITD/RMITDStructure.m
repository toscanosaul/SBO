...
T = 3; % Time Horizon
b = 100; % Quantity to buy
minmax = 1; % Maximize mean profit (-1 for minimize)
d = T-1; % T-1 quantities to reserve for periods [t,T] for t=2..T
m = 0; % No constraints
VarNature = ones(d, 0); % real variables
VarBds = [0, b]; % must reserve at most total amount bought
