...
\begin{figure}[tb]
    ...
    \includegraphics[width=0.30\linewidth]{comparisonAnalaytic.png}}
    \quad
    \subcaptionbox{Performance of SBO, on the Citi Bike Problem from Section~\ref{sec:citibike} \label{fig:citibike}}[0.30\linewidth]{
      \includegraphics[width=0.30\linewidth]{comparisonSameConfiguration.pdf}}
          \quad
...
\begin{figure}[tb]
    \centering
\subcaptionbox{Percentage increase between SBO and a Bayesian optimization benchmark, the KG method, when the difference between variances is $0.5$\label{fig:sim1}}[0.40\linewidth]{
    \includegraphics[width=0.40\linewidth]{contourPlotbetahN1A2.pdf}}
    \quad
    \subcaptionbox{Percentage increase between SBO and a Bayesian optimization benchmark, the KG method, when the difference between variances is $1/1024$ \label{fig:sim2}}[0.40\linewidth]{
      \includegraphics[width=0.40\linewidth]{contourPlotbetahN8A2.pdf}}
